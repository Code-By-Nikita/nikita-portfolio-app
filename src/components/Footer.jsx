  ...
  return (
    <>
      ...
      <div className="bg-[linear-gradient(to_right,_#500724,_#4a044e,_#500724)] text-white py-10 px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center gap-10 md:flex-row md:items-start md:text-left md:justify-between">
          {/* About Column */}
          <div className="flex-1 px-4">
            <h3 className="text-xl font-bold mb-4 font-roboto">More about myself</h3>
          ...
          <div className="flex-1 px-4">
            ...
            <ul className="space-y-2 text-sm font-roboto">
              <li>
                <a href="https://facebook.com" className="flex items-center gap-2 hover:text-yellow-200">
                  <FaFacebook /> Facebook
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/punch_art_diaries/" className="flex items-center gap-2 hover:text-yellow-200">
                  <FaInstagram /> Instagram
                </a>
              </li>
              <li>
                <a href="https://snapchat.com" className="flex items-center gap-2 hover:text-yellow-200">
                  <FaSnapchat /> Snapchat
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/nikita-choudhary3194/" className="flex items-center gap-2 hover:text-yellow-200">
                  <FaLinkedin /> LinkedIn
                </a>
              </li>
              <li>
                <a href="https://github.com/Code-By-Nikita" className="flex items-center gap-2 hover:text-yellow-200 font-weight-medium">
                  <FaGithub /> GitHub
                </a>
              </li>
            </ul>
          ...
          <div className="flex-1 px-4">
            ...
            <ul className="space-y-2 text-sm font-roboto">
              <li>
                <a href="mailto:nikita.choudhary3108@gmail.com" className="flex items-center gap-2 hover:text-yellow-200 font-weight-semibold">
                  <FaEnvelope /> Email: nikita.choudhary3108@gmail.com
                </a>
              </li>
              <li>
                <a href="tel:+918120198220" className="flex items-center gap-2 hover:text-yellow-200 font-weight-semibold">
                  <FaPhoneAlt /> Phone: 9168515339
                </a>
              </li>
              <li>
                <a href="https://t.me/yourtelegram" className="flex items-center gap-2 hover:text-yellow-200 font-weight-semibold">
                  <FaTelegramPlane /> Telegram: Nikita_Choudhary
                </a>
              </li>
              <li>
                <a href="https://wa.me/918847761997" className="flex items-center gap-2 hover:text-yellow-200 font-weight-semibold">
